...
<body>
	...
	<div id="content">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" placeholder="티켓이 사용이 되지를 않습니다." id="noticeTitle" name="noticeTitle">
			</div>
		</div>
		<div class="form-group">
			<label for="inputPassword" class="col-sm-2 control-label">내용</label>
			<div class="col-sm-10">
				<textarea id="qContent"class="form-control" style="height:30em" placeholder="이유를 정확히 모르겠지만 제 티켓이 사용되지 않습니다" id="noticeContents" name="noticeContents"></textarea>
			</div>
		</div>	
