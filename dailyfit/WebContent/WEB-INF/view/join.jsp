...
<link href="/dailyfit/css/join.css" rel="stylesheet">
...
<p class="font f12" style="height: 300px; overflow: auto; ">
	<span class="b f15">데일리핏 이용약관</span><br/><br/>제 1 조 (목적)
이 약관은 데일리핏 주식회사 ("회사" 또는 "데일리핏")가 제공하는 데일리핏 및 데일리핏 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 데일리핏 및 데일리핏 관련 제반 서비스를 의미합니다.
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.</p>
</div>
