		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion" aria-hidden="false"
						href="#collapse1" class = "collapsed"> <span
						class="glyphicon glyphicon-menu-right"></span> Collapsible Group
						Item #1
					</a>
				</h4>
			</div>
