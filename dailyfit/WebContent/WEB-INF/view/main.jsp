...
<body>
<div id="swipe" style="width: 100%; position: fixed; top: 78%; opacity:0.6; z-index: 5">
<img src="/dailyfit/img/swipe.PNG" width="100%">
</div>
	...
	<div id="contents" role="main" style="overflow: auto;">
		<div id="one" style="height: 100%;">
			...
			<div class="item" onclick="location.href='shop.ap'" onclick="location.href='shop.ap'">
			...
			<div class="item" onclick="location.href='shop.ap'">
